...
public:
	...
	*/
	...
	int CalcHistogram(const Mat& sourceImage, MatNode* histogram);//MatNode la mootj danh sach lien ket luu được nhiều kết quả histogram của nhiều kênh
	...
	*/
	...
	int DrawHistogram(const Mat& sourceImage, MatNode* histImage);//NodeNode chứa nhiều kết quả Hispgram kênh màu do đó vẽ được nhiều Biểu đồ Histogram
